...
@section('content')
    @if(session('status'))
        <div id="toast-success" class="mx-4 my-6 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            ...
            <div class="ms-3 text-sm font-normal">User update successfully</div>
