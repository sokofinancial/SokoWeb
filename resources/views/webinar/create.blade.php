...
@section("content")
    <form class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex flex-col md:p-6 xl:p-8 dark:bg-gray-800" method="POST" action="{{route('webinar.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="w-full flex justify-center">
            <img id="webinar-image" src="" class="h-44 rounded-lg" alt="">
        </div>

        <h3 class=" mt-5 flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">Create Webinar</h3>
