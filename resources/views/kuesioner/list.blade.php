...
@section("content")
    <div class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex flex-col md:p-6 xl:p-8 dark:bg-gray-800">
        <div class="flex w-full justify-between">
            <div>
                <h3 class="flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">Kuesioner Responden
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    @foreach($respondents as $respondent)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                {{$respondent->gender == 'male' ? 'Laki-laki': 'Perempuan'}}
                            </td>
                            <td class="px-6 py-4">
                                {{$respondent->address}}
                            </td>
