...
@section('content')
  <section class="container xl:max-w-screen-xl m-4 md:m-0 md:py-4">
    <div class="px-4">
      <span class="mt-3 md:mt-6 lg:mt-8 text-2xl font-extrabold block md:text-3xl lg:text-4xl">Konsultasi
        Keuangan</span>
    </div>
  </section>
  ...
  <section class="main-content bg-primary-100 w-full flex flex-col items-center">
    ...
    <div class="container xl:max-w-screen-xl my-4 md:m-0 px-4 flex flex-col justify-center gap-2 md:gap-4 lg:gap-8">
      <p class="text-white font-bold"><a href="service" class="hover:underline">Layanan</a> > <a href="financial-consulting"
          class="hover:underline">Konsultasi Keuangan</a>
      </p>
      @include('components.core.product-card', ['name' => 'Konsultasi Keuangan'])
