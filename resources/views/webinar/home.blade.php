...
@section("content")
    <div class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex flex-col md:p-6 xl:p-8 dark:bg-gray-800">
        <div class="text-right mb-4">
            <div>
                <a href="{{route('webinar.create')}}" class="inline-flex gap-2 justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="{{route('webinar.detail', ['slug' => $webinar->slug])}}">
                                <img class="object-cover w-full rounded-t-lg h-60 md:h-auto md:w-36 md:rounded-none md:rounded-s-lg" src="{{asset('storage/'.$webinar->image)}}"  alt="{{$webinar->image}}"/>
                            </a>
                        </td>
                        <td class="px-6 py-4">
                            {{ $webinar->title }}
